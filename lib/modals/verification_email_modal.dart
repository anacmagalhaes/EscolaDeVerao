...
void VerificationEmailModal(BuildContext context, String email) {
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                children: [
                  Fonts(
                    text: 'Verificação enviada para o e-mail cadastrado',
                    maxLines: 3,
                    fontSize: 16,
                  ...
                  SizedBox(height: 4.h),
                  Fonts(
                    text: 'Verifique a caixa de entrada do e-mail $maskedEmail',
                    maxLines: 4,
                    fontSize: 16,
